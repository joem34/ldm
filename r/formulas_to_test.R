...
#foursquare
f <- formula(choice ~ dist_exp + I(log(attraction)) + lang.barrier + mm_inter + mm_intra | 0 )
f <-formula(choice ~ log_fs_arts_entertainment + log_fs_hotel + log_fs_medical + log_fs_outdoor + log_fs_services + log_fs_skiarea | 0)
