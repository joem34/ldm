...
formulas <- c(
  ...
  formula(choice ~ dist_exp + dist_log_1000 + dist_log_1000_3000 + dist_log_3000  + civic + mm_inter_no_visit + mm_intra + r_intra + visit_log_medical + log_hotel + log_sightseeing  + niagara + leisure_log_outdoors + leisure_log_skiing | 0)
