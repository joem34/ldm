...
formulas <- c(
  ...
  formula(choice ~ dist_exp + civic + mm_inter_no_visit + mm_intra + r_intra + visit_log_medical + log_hotel + summer_log_outdoors + log_sightseeing  + niagara + winter_log_skiing | 0),
  formula(choice ~ dist_exp + dist_log  + civic + mm_inter_no_visit + mm_intra + r_intra + visit_log_medical + log_hotel + log_sightseeing  + niagara + summer_log_outdoors + winter_log_skiing | 0),
  )
